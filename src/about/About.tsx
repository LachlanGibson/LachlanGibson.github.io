  ...
  return (
    <section>
      ...
      <p>
        ...
        journey at the University of Queensland, where he pursued a dual program
        of a Bachelor of Science and a Bachelor of Arts from 2011 to 2014 with
        extended majors in Physics and Mathematics respectively. During his
        undergraduate years, Dr. Gibson was heavily involved in research
        programs, including the Advanced Study Program in Science (ASPinS), and
        was recognized by the UQ Summer Research Scholarship Program for three
        consecutive years.
        <br />
        <br />
        His desire for continuous learning led him to attain his Bachelor of
        Science (Honours) in 2015, achieving First Class Honours. His dedication
        was evident through his participation in a Simulation Group Internship,
        where he worked on simulations of the proposed Brisbane BaT tunnel.
        <br />
        <br />
        ...
        optical-tweezers systems. He then added to his expertise by completing a
        Masters of Data Science in 2020 with a capstone study project on
        Categorical Vector Clustering.
        <br />
        <br />
        Following his academic pursuits, Dr. Gibson embarked on a career as a
        Postdoctoral Research Fellow at the University of Queensland from August
        2020 to December 2022. His work involved researching rare-event
        ...
        controlling restless multi-armed bandits. He also served as an Academic
        Tutor from 2016 to 2020 for various Mathematics and Physics courses,
        highlighting his commitment to educating others.
        <br />
        <br />
        ...
        high school students from the church and local community. Additionally,
        he contributed to Scripture Union as a camp leader, and as an English
        Conversation Club Volunteer Helper at UQ's Institute of Continuing &
        TESOL Education.
        <br />
        <br />
