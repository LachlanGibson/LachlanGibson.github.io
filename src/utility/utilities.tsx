 ...
 *
 * @template Args - Tuple of argument types accepted by the function
 * @template R - The return type of the function
 * @param fn - The original function to memoise
 * @returns A memoised version of the original function with the same argument and return types
 *
 * @example
 ...
 */
export function memoise<Args extends unknown[], R>(
  fn: (...args: Args) => R
): (...args: Args) => R {
